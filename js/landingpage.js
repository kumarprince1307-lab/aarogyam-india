...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    /* ======================================================
        4. RICH SHARING & COPY LINK SYSTEM
    ====================================================== */
    ...
    document.getElementById("heroShareBtn")?.addEventListener("click", shareOnWhatsApp);
    document.getElementById("deskShareWhatsapp")?.addEventListener("click", shareOnWhatsApp);
    document.getElementById("mobileShareButton")?.addEventListener("click", shareOnWhatsApp);
    document.getElementById("mobileShareBtn")?.addEventListener("click", shareOnWhatsApp);

    document.getElementById("deskShareFb")?.addEventListener("click", shareOnFacebook);
    document.getElementById("deskShareCopy")?.addEventListener("click", copyLinkToClipboard);
