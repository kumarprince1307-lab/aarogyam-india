...
const ROUTES = {
  ...
  'all-landing-pages': () => import('./admin-pages-landing-pages.js?v=31.1').then(m => m.initAllLandingPages()),
  'book-landing-pages': () => import('./admin-pages-book-landing.js?v=31.1').then(m => m.initBookLandingPages()),
