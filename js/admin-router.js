...
const ROUTES = {
  ...
  'all-landing-pages': () => import('./admin-pages-landing-pages.js?v=30.2').then(m => m.initAllLandingPages()),
  'book-landing-pages': () => import('./admin-pages-book-landing.js?v=30.2').then(m => m.initBookLandingPages()),
