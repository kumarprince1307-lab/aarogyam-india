...
const ROUTES = {
  ...
  'all-landing-pages': () => import('./admin-pages-landing-pages.js').then(m => m.initAllLandingPages()),
  'book-landing-pages': () => import('./admin-pages-book-landing.js').then(m => m.initBookLandingPages()),
  'page-editor': () => import('./admin-pages-page-editor.js').then(m => m.initPageEditor()),
