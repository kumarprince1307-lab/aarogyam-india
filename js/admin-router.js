...
const ROUTES = {
  ...
  'all-webinars': () => import(`./admin-pages-webinars.js?v=32.0`).then(m => m.initWebinars()),
  'webinars': () => import(`./admin-pages-webinars.js?v=32.0`).then(m => m.initWebinars()),
  'webinar-reports': () => import('./admin-pages-webinar-reports.js?v=32.0').then(m => m.initWebinarReports()),
  'webinar-leads': () => import('./admin-pages-webinar-reports.js?v=32.0').then(m => m.initWebinarReports()),
